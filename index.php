    ...
    <div class="" style="height: 100px; background-color: #444444">
    	...
    	<div class="col-6 mx-auto shadow-lg main px-0">
    		...
    		<div class="text-center"> <!-- Див для списка фильмов -->
                <?php 
                    $id = ["1","2","3","4","5"];
                    $names = ["Побег из Шоушенка","Форест Гамп","Форсаж 7","1+1","Зеленая миля"];
                    $img = ["img/2.jpg","img/3.jpg","img/4.jpg","img/5.jpg","img/1.jpg"];

                    for ($i=0; $i < 5; $i++) { 
                        echo "<h2 class='mt-4'>". $id[$i]." ". $names[$i]. "</h2>";
                        echo "<img src='".$img[$i]."' class='mt-2' style='width: 400px;'>";
                    }
                ?>
